...
--------------
Find needed data and shape file here: Download csv from first link, download "shapefile" under "export" at second link. 
...
READ DATA LOADING STEP FOR DATA LOADING GUIDE. 
...
Data Loading. Need the selected public health indicates by community area data file from the city of Chicago data portal and the shape file for the 77 official Chicago community areas, also easily publicly available. 
...
#insert actual filepath to the location of the shapefile where it says "insert filepath here". 
map <- st_read("insert filepath here/geo_export_cceb8ce1-c228-4e57-a01b-9cea710b9da7.shp")
