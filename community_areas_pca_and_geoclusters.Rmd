...
#insert actual full fil epath to the location of the shapefile where it says file path. 
#The way I did this is 
#1. extracting all the files from the zipped download file
#2. insert the file path to the one that is a ".shp"
# make sure to "extract all" files from the zip file to and insert the file that is ".shp" in to the st_read function. 
