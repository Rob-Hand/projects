...
#messing around with the mapping visualizations. Interested if we can show each of the clusters compared to all the other ones if this would help with vis. for loop?
